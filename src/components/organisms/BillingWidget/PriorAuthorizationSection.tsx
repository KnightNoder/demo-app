            ...
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <h4 className="font-normal">Auth #{auth.authorization_number}</h4>
                    {auth.status && (
                      <div className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-normal transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:bg-gray-200 ${
              ...
              <div className="p-4">
                <div className="space-y-3 text-sm">
                  <div>
                    <div className="text-[#020817] mb-1 font-normal">Service Date</div>
                    <div className="font-light">{formatDate(auth.from_date)} - {formatDate(auth.to_date)}</div>
                  </div>
                  
                  <div>
                    <div className="text-[#020817] mb-1 font-normal">Insurance</div>
                  ...
                  {auth.services.length > 0 && (
                    <div className="mt-2 pt-2 border-t border-gray-200">
                      <div className="text-[#020817] mb-1 font-normal">Appeal Status</div>
